...
public class TC_001_AddNewStockDetails extends BaseClass {
   ...
   public static Object[][] getDetails() throws IOException {  
       ...
       try {  
           ...
           data = Excel_ReadData.ReadData("AddStock", "C:\\Users\\kamali\\git\\Medical-Store-System\\test-data\\MedicalStore_InputValues.xls");  
       } catch (Exception e) {  
   ...
   //    return Arrays.stream(data).filter(row -> row[0] != null && !row[0].toString().trim().isEmpty()).toArray(Object[][]::new);  
	...
	public void AddStockTestcase(String Data_NO,String MenuItem,String SubMenuItem1,String SubMenuItem2,String ItemName,
			String ManufacturerName,String UnitPrice,String Location,String CGST,String ItemDescription, 
			String BatchNumber,String Quantity,String SGST,String HSNCode,String Type,String DistributorName,String ExpiryDate
            ) throws InterruptedException 
      {
		 ...
		 * AddStock.CreateAddNewStock(ItemName,ManufacturerName,UnitPrice,Location,CGST,
		 * ItemDescription,BatchNumber,Quantity,SGST,HSNCode,Type,DistributorName);
		 * 
		 ...
		 * 
		 * Verification_AddNewStock AddStockVerf = new Verification_AddNewStock
		 * (driver); AddStockVerf.VerificationSearchField(ItemName);
		 * 
